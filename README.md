...
| `insurance` | Two LangGraph multi-agent pipelines: auto policy application intake, and a cyclic FNOL claims intake with a mandatory human-review gate (SQLite-checkpointed) |
